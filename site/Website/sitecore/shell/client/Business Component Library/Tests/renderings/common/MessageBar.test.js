  ...
  var setupTests = function (testAreaEl) {
    ...
    describe("Given a messageBar model", function () {
      ...
      describe("when I create a messageBar model", function () {
        ...
        it("it should have a translations object which contains translations as JSON", function () {
          expect(messageBar.get("translations")).toBeDefined();
          
          // Since we check messages on the model, and the messages are added through the view through Razor, then we set them here
          messageBar.set("translations", JSON.parse('{"errors":"errors","lessDetails":"Less details...","moreDetails":"More details...","notifications":"notifications","provideFunction":"sProvide function with conditions to check","provideTypeAndMessage":"Provide at least type and message","youHaveFew":"You have few","warnings":"warnings"}'));
        });
