  ...
  var setupTests = function (testAreaEl) {
    ...
    describe("Given a TreeView model", function () {
      ...
      describe("when I create a TreeView model", function () {
        ...
        it("it should have a 'showHiddenItems' property", function () {
          expect(treeView.get("showHiddenItems")).toBeDefined();
        });
        ...
        it("it should set 'showHiddenItems' to 'false' by default", function () {
          expect(treeView.get("showHiddenItems")).toBe(false);
        });
...
//          $e = null;
        ...
        it("it should set the 'showHiddenItems' property according to 'data-sc-showhiddenitems' on load", function () {
          expect(m.get("showHiddenItems")).toBe($e.attr("data-sc-option-showhiddenitems").toLowerCase() === "true");
        });
      });
